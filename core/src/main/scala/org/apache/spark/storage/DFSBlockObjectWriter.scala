 ...
 * reopened again.
 */
private[spark] class DFSBlockObjectWriter(
    val file: Path,
  ...
  private val fsHadoop = file.getFileSystem(hadoopConf)
   ...
   */
  // private var committedPosition = fsHadoop.getFileStatus(file).getLen
